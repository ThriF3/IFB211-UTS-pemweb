                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        <div class="col-span-1">
                            ...
                            <x-text-input id="id_ruang" class="mt-1 w-full bg-neutral-200" type="text" name="id_ruang" :value="$ruang['id_ruang']" required autofocus autocomplete="name" disabled />
                            <x-input-error :messages="$errors->get('id_ruang')" class="mt-2" />
                        </div>

                        <div class="col-span-3">
                            <x-input-label for="lokasi" :value="__('Lokasi')" />
                            <x-text-input id="lokasi" class="mt-1 w-full" type="text" name="lokasi" :value="$ruang['lokasi']" required autofocus autocomplete="name" />
                        ...
                        <div class="col-span-2">
                            ...
                            <select name="tipe" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full mt-1">
                                @if ($ruang['tipe'] == 'lab')
                                <option value="lab" selected>Labotarium</option>
                        ...
                        <div class="col-span-2">
                            ...
                            <x-text-input id="kapasitas" class="mt-1 w-full" type="text" name="kapasitas" :value="$ruang['kapasitas']" required autofocus autocomplete="name" />
