<x-app-layout>
    <form method="POST" action="{{ route('praktikum.update', $praktikum['id_praktikum'])}}">
        @csrf
        @method('PUT')
        <x-slot name="header">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <x-text-input id="id_praktikum" class="mt-1 w-full" type="text" name="id_praktikum" :value="$praktikum['id_praktikum']" required autofocus autocomplete="name" />
                        ...
                        <div class="col-span-2">
                            ...
                            <select name="id_matkul" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full mt-1">
                                ...
                                @if ($praktikum['id_matkul'] == $data['id_matkul'])
                                    selected
                                @endif
                                >{{ $data['id_matkul'] }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-span-4">
                            ...
                            <x-text-input id="kelas" class="mt-1 w-full" type="text" name="kelas" :value="$praktikum['kelas']" required autofocus autocomplete="name" />
