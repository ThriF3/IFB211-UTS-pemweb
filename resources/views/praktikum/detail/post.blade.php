        ...
        <div>
                        ...
                        <div class="flex">
                            ...
                            @if ($data['tipe'] == 'modul')
                                <h4 class="text-xs px-2 text-blue-400">
                                    {{ (new DateTime($data['startDate']))->format('d F Y') }}</h4>
                            @else
                                <h4 class="text-xs px-2 text-blue-400">
            ...
            <div class="mx-12 px-4 py-2 bg-gray-50 border-b-2 transition-all" id="accordion-{{ $data['id_post'] }}">
                <div class="flex gap-2 m-2">
                    ...
                    <div class="bg-white border border-gray-300 rounded-md px-4 py-2">
                        ...
                        <div class="grid grid-cols-3 mb-2">
                            ...
                            <div class="flex justify-end gap-2 col-span-2">
                                ...
                                <x-danger-button x-data=""
                                    x-on:click.prevent="$dispatch('open-modal', 'confirm-data-deletion-{{ $data['id_post'] }}')"><i
                                        class="fa-solid fa-trash"></i></x-danger-button>
